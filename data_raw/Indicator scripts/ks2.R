...
ks2 <- ks2_dataset |>
  ...
  select(pcon_code, ks2_percent_meeting_standard = pt_rwm_met_expected_standard) # Select relevant columns, measures percent meeting expected standard in reading, writing and maths
